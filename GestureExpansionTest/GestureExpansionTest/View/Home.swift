...
struct Home: View {
    ...
    @State var tools: [Tool] = [
        ...
        .init(icon: "bubbles.and.sparkles.fill", name: "Picker", color: .pink),
        ...
        VStack {
            ...
            .background {
                RoundedRectangle(cornerRadius: 10, style: .continuous)
                    .fill(.white.shadow(.drop(color: .black.opacity(0.1), radius: 5, x: 5, y: 5)
            ...
            .gesture(
                DragGesture(minimumDistance: 0)
                    .onChanged({ value in
                        ...
                        let location: CGPoint = CGPoint(x: startedToolPosition.midX, y: value.location.y)
    ...
    func ToolView(tool: Binding<Tool>) -> some View {
        ...
        // Image Size - 45, trailing - 10 Extra space - 5
        // Total = 60
